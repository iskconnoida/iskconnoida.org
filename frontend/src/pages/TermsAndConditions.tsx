      ...
      >
        <div className="flex flex-col gap-5 my-16">
          ...
          <p>
            ...
            conditions. Do not continue to use ISKCON NOIDA if you do not agree
            to take all of the terms and conditions stated on this page.
          </p>
          <p>
            The following terminology applies to these Terms and Conditions,
            Privacy Statement and Disclaimer Notice and all Agreements:
            “Client”, “You” and “Your” refers to you, the person logging on this
          ...
          <p>
            We employ the use of cookies. By accessing ISKCON NOIDA, you agreed
            to use cookies in agreement with the International Society for
            Krishna Consciousness’s Privacy Policy.
          </p>
          <p>
          ...
          <p>
            Unless otherwise stated, International Society for Krishna
            Consciousness and/or its licensors own the intellectual property
            rights for all material on ISKCON NOIDA. All intellectual property
            rights are reserved. You may access this from ISKCON NOIDA for your
            own personal use subjected to restrictions set in these terms and
            conditions.
          </p>
          <p>You must not:</p>
          <ul className="list-disc ml-6">
            <li>Republish material from ISKCON NOIDA</li>
            <li>Sell, rent or sub-license material from ISKCON NOIDA</li>
            <li>Reproduce, duplicate or copy material from ISKCON NOIDA</li>
            <li>Redistribute content from ISKCON NOIDA</li>
          </ul>
          <p>
            Parts of this website offer an opportunity for users to post and
            exchange opinions and information in certain areas of the website.
            International Society for Krishna Consciousness does not filter,
            edit, publish or review Comments prior to their presence on the
            website. Comments do not reflect the views and opinions of
            International Society for Krishna Consciousness, its agents and/or
            ...
            applicable laws, International Society for Krishna Consciousness
          ...
          <p>
            International Society for Krishna Consciousness reserves the right
          ...
          <p>
            You hereby grant International Society for Krishna Consciousness a
          ...
          <p>
            ...
            visibility of the hyperlink compensates the absence of International
            Society for Krishna Consciousness; and (d) the link is in the
          ...
          <p>
            ...
            sending an e-mail to International Society for Krishna
            Consciousness. Please include your name, your organization name,
          ...
          <p>
            No use of International Society for Krishna Consciousness’s logo or
