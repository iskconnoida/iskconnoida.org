    ...
    <>
      ...
      <Suspense
        fallback={
          <div
            role="status"
            className="mb-16 flex flex-col gap-2 w-full h-screen items-center text-center justify-center"
          >
            <svg
              aria-hidden="true"
              className="w-8 h-8 text-gray-200 animate-spin fill-primary500"
              viewBox="0 0 100 101"
              fill="none"
            >
              <path
