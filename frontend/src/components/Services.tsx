    ...
    <>
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-1 md:gap-2 lg:gap-4">
        <div className="items-center p-4">
          <div className="mx-auto bg-primary-200 border-2 border-primary-500 w-fit rounded-full">
            <img
              src="/images/cow.webp"
      ...
      <button className="sm:hidden border border-primary-700 rounded-lg bg-primary-600 px-4 py-2 text-white shadow-lg shadow-primary-300 hover:shadow-primary-300 hover:shadow-xl">
        <Link to="/services">View More</Link>
      </button>
    </>
  );
