...
export default function Navbar() {
  return (
    <div className="h-16 w-full flex justify-between items-center px-4 lg:px-10 bg-white border-b border-gray-700/20 shadow-lg rounded-b-lg bg-clip-padding fixed top-0 left-0 right-0 z-20">
      <span className="">
