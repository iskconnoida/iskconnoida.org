...
const Navbar: React.FC = () => {
  ...
  return (
    <div className="h-16 w-full flex justify-between items-center px-4 lg:px-10 bg-white shadow-lg rounded-b-lg bg-clip-padding border-2 fixed top-0 left-0 right-0 z-20">
      <img src="/images/logo.webp" alt="logo" className="md:mx-0 mx-auto h-14" />
      <span className="md:flex w-[60%] items-center justify-evenly hidden">
        ...
        <Link to='/events' className={`md:text-base lg:text-xl font-semibold text-gray-600 rounded-full px-2 py-1 text-shadow-lg shadow-purple-100 ${isActive('/festivals')? "bg-gray-600 text-white" : "bg-white"}`}>Festivals</Link>
