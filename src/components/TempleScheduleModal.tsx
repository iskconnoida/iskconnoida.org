    ...
    return (
        <div className="fixed inset-0 bg-black bg-opacity-50 pt-36 flex items-center justify-center z-50" onClick={handleOverlayClick}>
            <div className="bg-white w-full max-w-lg p-8 rounded-lg relative max-h-[80vh] overflow-y-auto">
                ...
                <h2 className="text-2xl font-bold text-purple-300 mb-4">Temple timings | Open all days</h2>
                ...
                <div className="grid grid-cols-2 gap-4">
                    ...
                    <div>
                        <p className="font-bold text-lg">16:15</p>
                        <p>Usthapan arati</p>
                        <p className="text-sm text-gray-400">Early evening worship</p>
                    </div>
                    <div>
                        <p className="font-bold text-lg">07:15</p>
                        <p>Sringar darshan</p>
                    ...
                    <div>
                        <p className="font-bold text-lg">07:25</p>
                        <p>Guru puja</p>
                        <p className="text-sm text-gray-400">Honoring the Founder-acharya</p>
                    </div>
                    <div>
                        <p className="font-bold text-lg">19:30</p>
