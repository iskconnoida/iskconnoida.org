  ...
  return (
    <>
      <div id="hero" className="lg:mt-[3.5rem] h-[calc(100vh-3.5rem)] flex flex-col w-screen bg-center bg-no-repeat bg-cover text-center">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center mt-4 space-x-2 sm:space-y-0 sm:space-x-2">
        ...
        <div className="text-center mt-6">
          <button className="border border-violet-700 rounded-lg bg-violet-600 px-4 py-2 text-white shadow-lg shadow-violet-300 hover:shadow-violet-300 hover:shadow-xl">View Temple Schedule</button>
        </div>
        </div>
        </div>
