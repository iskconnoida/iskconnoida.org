...
import { FaHome, FaHandSparkles} from "react-icons/fa"; 
...
function BottomBar() {
  ...
  return (
    <section className="fixed bottom-0 z-10 w-full rounded-t-3xl bg-white px-4 py-2 backdrop-blur-sm border-2 xs:px-4 md:hidden">
        ...
        <Link to='/events' className={`xs:text-xs md:text-base lg:text-xl font-semibold text-gray-600 rounded-lg xs:px-1 px-1 ${isActive("/events") ? "bg-gray-600 text-white" : "bg-white"}`}><BiDonateHeart size={24} className="ml-2" /> Festivals</Link>
          <button
          onClick={togglePopup}
          ...
          <div className="fixed inset-0 flex items-end justify-center bg-opacity-0">
            <div className="relative w-full bg-white rounded-t-3xl p-5 mb-14">
              ...
              <div className="">
                ...
                <Link to='/media' className="block px-4 py-2 text-black hover:bg-gray-200">Media</Link>
