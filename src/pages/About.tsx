      ...
      <div id="about">
        <Writeup title="About ISKCON Noida">
          ...
          <p>
            ...
            beacon of devotion and knowledge, inviting visitors to embark on a
          ...
          <p>
            ...
            Bhaktivedanta courses, delving deep into the timeless wisdom of the
            Vedas and Bhagavad Gita.
          </p>

          <p>
            Within our sacred walls, you will find the divine presence of Sri
            Sri Radha Govind Dev, Sri Sri Jagannath Baldev Subhadra, and Sri Sri
            Gaura Nitai, whose benevolent gaze fills the hearts of devotees with
            love and devotion.
          </p>

          <p>
            Join us in our daily rituals, as the temple opens its doors from
            4:30 am to 1 pm, and then again from 4:30 pm to 8:30 pm. Witness the
            enchanting spectacle of deity adornments, changed daily, and partake
            in the six aartis performed with utmost reverence and devotion.
          </p>

          <p>
            Experience the warmth of our temple facilities, including the "Back
            to Godhead" Guest House, offering a serene retreat for pilgrims and
            seekers alike. Explore the Krishna Expo, where intricate 3D models
            unravel the profound science of Vedic literatures, guiding visitors
          ...
          <p>
            Come, immerse yourself in the divine embrace of ISKCON Noida Temple,
            where spirituality meets serenity, and every moment is a step closer
            to the divine.
          </p>
        </Writeup>
      </div>
      <div id="prabhupada">
        <Writeup title="About Prabhupada">
          ...
          <p>
            ...
            Swami Prabhupada, is the founder-acharya of the International
            Society for Krishna Consciousness (ISKCON), commonly known as the
            Hare Krishna movement. He was born Abhay Charan De on September 1,
            1896, in Calcutta, India, into a devout Vaishnava family.
          </p>

          <p>
            From a young age, Abhay Charan De showed a keen interest in
            spirituality and devotion to Lord Krishna. In 1922, he met his
            spiritual master, Srila Bhaktisiddhanta Sarasvati Thakura, who urged
            him to spread the teachings of Lord Chaitanya Mahaprabhu and the
            practice of Krishna consciousness in the English-speaking world.
          </p>

          <p>
            After receiving the blessings and instruction from his guru, Abhay
            Charan De dedicated his life to fulfilling this mission. In 1965, at
            the age of 69, he embarked on a historic journey to the United
            States, carrying with him only his faith, determination, and a trunk
            of Srimad-Bhagavatam translations.
          </p>

          <p>
            Facing numerous challenges and obstacles, Srila Prabhupada
            tirelessly preached the message of Krishna consciousness, conducting
            public lectures, distributing books, and establishing temples and
            centers around the world. His teachings emphasized the chanting of
            the Hare Krishna mantra as the most effective means of spiritual
            realization in this age.
          </p>

          <p>
            Under his guidance, ISKCON grew rapidly, attracting thousands of
            followers from diverse backgrounds. Srila Prabhupada's translations
            and commentaries on ancient Vedic texts, such as the Bhagavad Gita
            and the Srimad-Bhagavatam, became widely acclaimed for their clarity
            and depth.
          </p>
          ...
          <p>
            ...
            left behind a legacy of spiritual wisdom, devotion, and service that
          ...
          <ul className="list-disc pl-6 pt-4">
            ...
            <li>
              <span className="font-bold">
                ...
                in the great scriptures of India, Bhagavad-gita and
                Srimad-Bhagavatam:
              </span>{" "}
            ...
            <li>
              ...
              ISKCON places a strong emphasis on the Sankirtana movement, which
              involves the congregational chanting of the Hare Krishna mantra as
              a means of spiritual upliftment and enlightenment. Through
              chanting, devotees aim to purify their hearts, cultivate love for
              God, and spread peace and harmony throughout society.
            </li>
            <li>
              <span className="font-bold">
              ...
              ISKCON seeks to establish temples and spiritual centers dedicated
              to Lord Krishna where devotees can come together to worship,
              study, and engage in devotional activities. These temples serve as
              sacred spaces for spiritual growth and enlightenment, as well as
              centers for outreach and community service.
            </li>
            <li>
              <span className="font-bold">
              ...
              members seek to reduce materialistic distractions and cultivate a
              deeper connection with God and nature.
            </li>
            <li>
              <span className="font-bold">
